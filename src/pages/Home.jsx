...
// Note: PenTool and Layout were from lucide-react but I missed them in the import for this specific block. 
  ...
  return (
    <>
      ...
      <section className="relative pt-24 pb-12 sm:pt-32 sm:pb-20 lg:pt-40 lg:pb-32 overflow-hidden min-h-[85vh] flex items-center">
        <GridPattern
          squares={[
            [4, 4], [5, 1], [8, 2], [5, 3], [5, 5], [10, 10], [12, 15], [15, 10], [10, 15],
          ]}
          className={cn(
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <motion.h1 variants={fadeIn} className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-heading font-black leading-[1.1] sm:leading-[1] text-slate-900 mb-6 sm:mb-8 tracking-tighter uppercase">
                <WaveText text="Grow " />
              ...
              <motion.div variants={fadeIn} className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 justify-center lg:justify-start">
                <button 
                  ...
                  className="w-full sm:w-auto bg-slate-900 text-white px-8 py-4 sm:px-12 sm:py-6 rounded-[2rem] font-black text-base sm:text-lg hover:bg-brand-primary transition-all shadow-2xl hover:shadow-brand-primary/30 flex items-center justify-center gap-3 group uppercase tracking-tight"
                >
                  Start Growth
            ...
            >
              <div className="relative p-8 sm:p-10 rounded-[2.5rem] bg-slate-950 border border-slate-800 shadow-[0_64px_96px_-16px_rgba(0,0,0,0.5)] overflow-hidden group">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <motion.div
              ...
              variants={fadeIn}
            >
              <h2 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-heading font-black text-slate-900 mb-6 sm:mb-8 tracking-tighter leading-[1] sm:leading-[0.95] uppercase">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-12">
            <div className="max-w-3xl">
              ...
              <h2 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-heading font-black tracking-tighter leading-[1] sm:leading-[0.9] uppercase">
      ...
      <section id="process" className="section-padding bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-32">
            <h2 className="text-4xl sm:text-5xl lg:text-7xl xl:text-8xl font-heading font-black text-slate-900 tracking-tighter mb-8 leading-[1] sm:leading-[0.9] uppercase">
              <WaveText text="How " />
      ...
      <section id="testimonials" className="py-32 bg-slate-950 overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 mb-20 text-center relative z-10">
          ...
          <h2 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-heading font-black text-white tracking-tighter mb-8 leading-[1] uppercase">
            <WaveText text="What " />
          ...
          <div className="flex overflow-hidden group">
            ...
            >
              {[...testimonialsRow1, ...testimonialsRow1].map((t, i) => (
                <div key={i} className="inline-block w-[300px] sm:w-[350px] lg:w-[400px] p-6 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] bg-slate-900/50 border border-slate-800 md:backdrop-blur-xl hover:border-brand-primary/50 transition-all duration-500">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="relative rounded-3xl sm:rounded-[5rem] bg-slate-950 p-8 sm:p-12 lg:p-32 overflow-hidden text-center group">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
              ...
              <h2 className="text-4xl sm:text-6xl lg:text-7xl xl:text-9xl font-heading font-black text-white tracking-[calc(-0.05em)] leading-[1] sm:leading-[0.85] mb-8 sm:mb-12 uppercase">
              ...
              <button 
                onClick={openLeadModal}
                className="bg-white text-slate-950 px-8 py-4 sm:px-16 sm:py-8 rounded-[2rem] sm:rounded-[3rem] font-black text-lg sm:text-2xl hover:scale-105 active:scale-95 transition-all shadow-2xl hover:shadow-brand-primary/40 flex items-center justify-center gap-4 sm:gap-6 mx-auto group uppercase tracking-tighter"
              >
...
// Added PenTool and Layout back to imports if needed, but actually I should have imported them at the top.
// I'll make sure the final file is correct.
