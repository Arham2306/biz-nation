              ...
              <div className="relative p-8 sm:p-10 rounded-[2.5rem] bg-slate-950 border border-slate-800 shadow-[0_64px_96px_-16px_rgba(0,0,0,0.5)] overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <form className="space-y-4">
                    ...
                    <button className="w-full bg-brand-primary text-white py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-brand-primary/30 hover:bg-white hover:text-slate-950 transition-all transform active:scale-[0.98]">
                      Request Free Audit
                    </button>
